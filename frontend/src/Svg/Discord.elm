...
discordLogo =
    Element.html
        (svg
            [ SvgAttr.viewBox "0 0 508.67 96.36"
            ]
            [ Svg.defs []
                [ Svg.style []
                    [ text ".cls-1{fill:#5865f2;}" ]
                ]
            , Svg.g
                [ SvgAttr.id "图层_2"
                , Attr.attribute "data-name" "图层 2"
                ]
                [ Svg.g
                    [ SvgAttr.id "Discord_Logos"
                    , Attr.attribute "data-name" "Discord Logos"
                    ]
                    [ Svg.g
                        [ SvgAttr.id "Discord_Logo_-_Large_-_White"
                        , Attr.attribute "data-name" "Discord Logo - Large - White"
                        ]
                        [ path
                            [ SvgAttr.class "cls-1"
                            , SvgAttr.d "M170.85,20.2h27.3q9.87,0,16.7,3.08a22.5,22.5,0,0,1,10.21,8.58,23.34,23.34,0,0,1,3.4,12.56A23.24,23.24,0,0,1,224.93,57a23.94,23.94,0,0,1-10.79,8.92q-7.24,3.3-17.95,3.29H170.85Zm25.06,36.54q6.65,0,10.22-3.32a11.8,11.8,0,0,0,3.57-9.07,11.5,11.5,0,0,0-3.18-8.5q-3.2-3.18-9.63-3.19h-8.54V56.74Z"
                            ]
                            []
                        , path
                            [ SvgAttr.class "cls-1"
                        ...
                        , path
                            [ SvgAttr.class "cls-1"
                            , SvgAttr.d "M451.69,29V44.14a12.47,12.47,0,0,0-6.93-1.75c-3.73,0-6.61,1.14-8.61,3.4s-3,5.77-3,10.53V69.2H416V28.25h16.8v13q1.4-7.14,4.52-10.53a10.38,10.38,0,0,1,8-3.4A11.71,11.71,0,0,1,451.69,29Z"
                            ]
                            []
                        , path
                            [ SvgAttr.class "cls-1"
                        ...
                        , path
                            [ SvgAttr.class "cls-1"
                            , SvgAttr.d "M234.36,37.9a22.08,22.08,0,0,0,17.11,0V69.42H234.36Z"
                            ]
                            []
                        ]
                    ]
